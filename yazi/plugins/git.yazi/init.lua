...
local function setup(st, opts)
    ...
    local styles = {
        [6] = t.modified and ui.Style(t.modified) or ui.Style():fg("#f9e2af"),
        [5] = t.added and ui.Style(t.added) or ui.Style():fg("#a6e3a1"),
        [4] = t.untracked and ui.Style(t.untracked) or ui.Style():fg("#6c7086"),
        [3] = t.ignored and ui.Style(t.ignored) or ui.Style():fg("#313244"),
        [2] = t.deleted and ui.Style(t.deleted) or ui.Style():fg("#f38ba8"),
        [1] = t.updated and ui.Style(t.updated) or ui.Style():fg("#89b4fa"),
    }
    local signs = {
